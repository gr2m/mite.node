module.exports = (function() {
  ...
  // API
  Customer.prototype.all = function(params, callback) {
    this.get('customers', params, callback);
  };
  Customer.prototype.archived = function(params, callback) {
    this.get('customers/archived', params, callback);
  };
