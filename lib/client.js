...
exports.createClient = function createClient(clientOptions) {
  ...
  clientHeaders = Helpers.mergeAttributes(defaultHeaders, clientOptions.headers);
  ...
  function Request(method, url, options) {
    ...
    // allow paths only
    parsedUrl.host = parsedUrl.host || clientHeaders.host
    parsedUrl.hostname = parsedUrl.hostname || clientHeaders.host
  ...
  Request.prototype._parseURL = function (url) {
    ...
    return Helpers.mergeAttributes(parsedUrl, container);
  };
  ...
  return {
    ...
    get: function (url, requestHeaders) {
      var headers = Helpers.mergeAttributes(clientHeaders, requestHeaders);
